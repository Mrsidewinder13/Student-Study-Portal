...
def homework(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            homeworks.save()
            messages.success(request,f'Homework Successfully Added from {request.user.username}!!!')
...
def todo(request):
    if request.method == 'POST':
        ...
        todos.save()
        messages.success(request,f'New Todo From {request.user.username} Added Successfully !!!')
    else:
        form = TodoForm()
